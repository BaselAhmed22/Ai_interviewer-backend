...
STTProvider/LLMProvider/TTSProvider (app/interviews/providers/base.py) —
nothing else in the codebase (VoiceAgent, the LiveKit worker, other
agents) needs to change.
"""
from app.core.config import settings
from app.interviews.providers.base import LLMProvider, STTProvider, TTSProvider
from app.interviews.providers.deepgram_provider import DeepgramSTTProvider
from app.interviews.providers.elevenlabs_provider import ElevenLabsTTSProvider
from app.interviews.providers.gemma_provider import GemmaLLMProvider
from app.interviews.providers.openai_provider import OpenAILLMProvider, OpenAISTTProvider
from app.interviews.providers.rime_provider import RimeTTSProvider
