...
(evaluate). See app/agents/ for the five agent modules and
app/services/interview_pipeline.py for the orchestrator.
...
from app.services.interview_pipeline import interview_pipeline_manager
